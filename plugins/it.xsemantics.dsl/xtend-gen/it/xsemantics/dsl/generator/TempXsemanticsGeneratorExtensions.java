...
public class TempXsemanticsGeneratorExtensions {
  @Inject
    ...
    String _xblockexpression = null;
    {
      ...
      final Function1<InputParameter,CharSequence> _function = new Function1<InputParameter,CharSequence>() {
          public CharSequence apply(final InputParameter it) {
            StringConcatenation _builder = new StringConcatenation();
            String _inputParameterName = TempXsemanticsGeneratorExtensions.this.inputParameterName(it);
    ...
    String _xblockexpression = null;
    {
      ...
      final Function1<RuleConclusionElement,CharSequence> _function = new Function1<RuleConclusionElement,CharSequence>() {
          public CharSequence apply(final RuleConclusionElement it) {
            StringConcatenation _builder = new StringConcatenation();
            CharSequence _resultVariableForTrace = TempXsemanticsGeneratorExtensions.this.resultVariableForTrace();
            _builder.append(_resultVariableForTrace, "");
            _builder.append(".");
            String _next = getMethods.next();
            _builder.append(_next, "");
            CharSequence _wrapInStringRepr = TempXsemanticsGeneratorExtensions.this.wrapInStringRepr(_builder);
      ...
      final Function1<RuleConclusionElement,CharSequence> _function_1 = new Function1<RuleConclusionElement,CharSequence>() {
          public CharSequence apply(final RuleConclusionElement it) {
            String _ruleConclusionInputParamForError = TempXsemanticsGeneratorExtensions.this.ruleConclusionInputParamForError(it);
            CharSequence _wrapInStringRepr = TempXsemanticsGeneratorExtensions.this.wrapInStringRepr(_ruleConclusionInputParamForError);
            return _wrapInStringRepr;
          }
        };
    ...
    String _xblockexpression = null;
    {
      ...
      final Procedure1<RuleConclusionElement> _function = new Procedure1<RuleConclusionElement>() {
          public void apply(final RuleConclusionElement it) {
            ...
            boolean _isOutputParameter = TempXsemanticsGeneratorExtensions.this._xsemanticsUtils.isOutputParameter(_next);
  ...
  public String errorForRule(final Rule rule) {
    final Function1<RuleConclusionElement,CharSequence> _function = new Function1<RuleConclusionElement,CharSequence>() {
        public CharSequence apply(final RuleConclusionElement it) {
          StringConcatenation _builder = new StringConcatenation();
          _builder.append("\"");
          String _ruleConclusionOutputParamForError = TempXsemanticsGeneratorExtensions.this.ruleConclusionOutputParamForError(it);
