...
/**
 * Manual modifications go to {it.xsemantics.dsl.XsemanticsRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractXsemanticsRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "it/xsemantics/dsl/Xsemantics.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("it.xsemantics.dsl.Xsemantics");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("xsemantics");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return it.xsemantics.dsl.services.XsemanticsGrammarAccess.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return it.xsemantics.dsl.parser.antlr.XsemanticsParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return it.xsemantics.dsl.parser.antlr.XsemanticsAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return it.xsemantics.dsl.parser.antlr.internal.InternalXsemanticsLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<it.xsemantics.dsl.parser.antlr.internal.InternalXsemanticsLexer> provideInternalXsemanticsLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(it.xsemantics.dsl.parser.antlr.internal.InternalXsemanticsLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(it.xsemantics.dsl.parser.antlr.internal.InternalXsemanticsLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends it.xsemantics.dsl.validation.XsemanticsJavaValidator> bindXsemanticsJavaValidator() {
		return it.xsemantics.dsl.validation.XsemanticsJavaValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return it.xsemantics.dsl.formatting.XsemanticsFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return it.xsemantics.dsl.jvmmodel.XsemanticsJvmModelInferrer.class;
	}
