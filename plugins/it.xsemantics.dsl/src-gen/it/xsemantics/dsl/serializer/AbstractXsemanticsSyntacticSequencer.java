...
public abstract class AbstractXsemanticsSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected String getUnassignedRuleCallToken(EObject semanticObject, RuleCall ruleCall, INode node) {
		...
		else if(ruleCall.getRule() == grammarAccess.getEnvironmentCompositionRule())
			return getEnvironmentCompositionToken(semanticObject, ruleCall, node);
		else if(ruleCall.getRule() == grammarAccess.getEnvironmentMapsToRule())
			return getEnvironmentMapsToToken(semanticObject, ruleCall, node);
