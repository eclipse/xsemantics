...
public class AbstractXsemanticsSemanticSequencer extends AbstractSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == TypesPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case XbasePackage.XNULL_LITERAL:
				if(context == grammarAccess.getPremiseExpressionRule() ||
				   ...
				   context == grammarAccess.getXRelationalExpressionAccess().getXInstanceOfExpressionExpressionAction_1_0_0_0_0() ||
				   context == grammarAccess.getXUnaryOperationRule()) {
					sequence_XExpressionInsideBlock(context, (XNullLiteral) semanticObject); 
					return; 
				}
				else break;
		...
		else if(semanticObject.eClass().getEPackage() == XsemanticsPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case XsemanticsPackage.CHECK_RULE:
				if(context == grammarAccess.getCheckRuleRule()) {
					sequence_CheckRule(context, (CheckRule) semanticObject); 
					return; 
				}
				else break;
			...
			case XsemanticsPackage.ENVIRONMENT_ACCESS:
				if(context == grammarAccess.getEnvironmentAccessRule() ||
				   ...
				   context == grammarAccess.getXRelationalExpressionAccess().getXInstanceOfExpressionExpressionAction_1_0_0_0_0() ||
				   context == grammarAccess.getXUnaryOperationRule()) {
					sequence_EnvironmentAccess(context, (EnvironmentAccess) semanticObject); 
					return; 
				}
				else break;
			case XsemanticsPackage.ENVIRONMENT_COMPOSITION:
				if(context == grammarAccess.getEnvironmentSpecificationRule() ||
				   context == grammarAccess.getEnvironmentSpecificationAccess().getEnvironmentCompositionCurrentEnvironmentAction_1_0_0()) {
					sequence_EnvironmentSpecification(context, (EnvironmentComposition) semanticObject); 
					return; 
				}
				else break;
			case XsemanticsPackage.ENVIRONMENT_MAPPING:
				if(context == grammarAccess.getEnvironmentSpecificationRule() ||
				   context == grammarAccess.getEnvironmentSpecificationAccess().getEnvironmentCompositionCurrentEnvironmentAction_1_0_0() ||
				   context == grammarAccess.getTerminalEnvironmentSpecificationRule()) {
					sequence_TerminalEnvironmentSpecification(context, (EnvironmentMapping) semanticObject); 
					return; 
				}
				else break;
			case XsemanticsPackage.ENVIRONMENT_REFERENCE:
				if(context == grammarAccess.getEnvironmentReferenceRule() ||
				   context == grammarAccess.getEnvironmentSpecificationRule() ||
				   context == grammarAccess.getEnvironmentSpecificationAccess().getEnvironmentCompositionCurrentEnvironmentAction_1_0_0() ||
				   context == grammarAccess.getTerminalEnvironmentSpecificationRule()) {
					sequence_EnvironmentReference(context, (EnvironmentReference) semanticObject); 
					return; 
				}
				else break;
			...
			case XsemanticsPackage.EXPRESSION_IN_CONCLUSION:
				if(context == grammarAccess.getExpressionInConclusionRule() ||
				   context == grammarAccess.getRuleConclusionElementRule()) {
					sequence_ExpressionInConclusion(context, (ExpressionInConclusion) semanticObject); 
					return; 
				}
				else break;
			case XsemanticsPackage.FAIL:
				if(context == grammarAccess.getPremiseExpressionRule() ||
				   ...
				   context == grammarAccess.getTerminalPremiseExpressionRule() ||
				   context == grammarAccess.getXExpressionInsideBlockRule()) {
					sequence_TerminalPremiseExpression(context, (Fail) semanticObject); 
					return; 
				}
				else break;
			...
			case XsemanticsPackage.OR_EXPRESSION:
				if(context == grammarAccess.getPremiseExpressionRule() ||
				   context == grammarAccess.getPremiseExpressionAccess().getOrExpressionBranchesAction_1_0_0() ||
				   context == grammarAccess.getXExpressionInsideBlockRule()) {
					sequence_PremiseExpression(context, (OrExpression) semanticObject); 
					return; 
				}
				else break;
			case XsemanticsPackage.OUTPUT_PARAMETER:
				if(context == grammarAccess.getJudgmentParameterRule()) {
					sequence_JudgmentParameter(context, (OutputParameter) semanticObject); 
					return; 
				}
				else break;
			case XsemanticsPackage.RULE_CONCLUSION:
				if(context == grammarAccess.getRuleConclusionRule()) {
					sequence_RuleConclusion(context, (RuleConclusion) semanticObject); 
					return; 
				}
				else break;
			case XsemanticsPackage.RULE_INVOCATION:
				if(context == grammarAccess.getPremiseExpressionRule() ||
				   context == grammarAccess.getPremiseExpressionAccess().getOrExpressionBranchesAction_1_0_0() ||
				   context == grammarAccess.getRuleInvocationRule() ||
				   context == grammarAccess.getTerminalPremiseExpressionRule() ||
				   context == grammarAccess.getXExpressionInsideBlockRule()) {
			...
			case XsemanticsPackage.RULE_PARAMETER:
				if(context == grammarAccess.getRuleConclusionElementRule() ||
				   context == grammarAccess.getRuleParameterRule()) {
					sequence_RuleParameter(context, (RuleParameter) semanticObject); 
					return; 
				}
				else break;
			...
			case XsemanticsPackage.XSEMANTICS_SYSTEM:
				if(context == grammarAccess.getXsemanticsSystemRule()) {
					sequence_XsemanticsSystem(context, (XsemanticsSystem) semanticObject); 
					return; 
				}
				else break;
			}
	...
	/**
	 * Constraint:
	 *     (environment=[Environment|ID] argument=XExpression type=JvmTypeReference)
	 */
	protected void sequence_EnvironmentAccess(EObject context, EnvironmentAccess semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, XsemanticsPackage.Literals.ENVIRONMENT_ACCESS__ENVIRONMENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XsemanticsPackage.Literals.ENVIRONMENT_ACCESS__ENVIRONMENT));
			if(transientValues.isValueTransient(semanticObject, XsemanticsPackage.Literals.ENVIRONMENT_ACCESS__ARGUMENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XsemanticsPackage.Literals.ENVIRONMENT_ACCESS__ARGUMENT));
			if(transientValues.isValueTransient(semanticObject, XsemanticsPackage.Literals.ENVIRONMENT_ACCESS__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XsemanticsPackage.Literals.ENVIRONMENT_ACCESS__TYPE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getEnvironmentAccessAccess().getEnvironmentEnvironmentIDTerminalRuleCall_3_0_1(), semanticObject.getEnvironment());
		feeder.accept(grammarAccess.getEnvironmentAccessAccess().getArgumentXExpressionParserRuleCall_5_0(), semanticObject.getArgument());
		feeder.accept(grammarAccess.getEnvironmentAccessAccess().getTypeJvmTypeReferenceParserRuleCall_7_0(), semanticObject.getType());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_EnvironmentReference(EObject context, EnvironmentReference semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, XsemanticsPackage.Literals.ENVIRONMENT_REFERENCE__ENVIRONMENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XsemanticsPackage.Literals.ENVIRONMENT_REFERENCE__ENVIRONMENT));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getEnvironmentReferenceAccess().getEnvironmentEnvironmentIDTerminalRuleCall_1_0_1(), semanticObject.getEnvironment());
		feeder.finish();
	}
	...
	protected void sequence_EnvironmentSpecification(EObject context, EnvironmentComposition semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, XsemanticsPackage.Literals.ENVIRONMENT_COMPOSITION__CURRENT_ENVIRONMENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XsemanticsPackage.Literals.ENVIRONMENT_COMPOSITION__CURRENT_ENVIRONMENT));
			if(transientValues.isValueTransient(semanticObject, XsemanticsPackage.Literals.ENVIRONMENT_COMPOSITION__SUB_ENVIRONMENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XsemanticsPackage.Literals.ENVIRONMENT_COMPOSITION__SUB_ENVIRONMENT));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getEnvironmentSpecificationAccess().getEnvironmentCompositionCurrentEnvironmentAction_1_0_0(), semanticObject.getCurrentEnvironment());
		feeder.accept(grammarAccess.getEnvironmentSpecificationAccess().getSubEnvironmentEnvironmentSpecificationParserRuleCall_1_0_2_0(), semanticObject.getSubEnvironment());
		feeder.finish();
	}
	...
	protected void sequence_Environment(EObject context, Environment semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, XsemanticsPackage.Literals.ENVIRONMENT__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XsemanticsPackage.Literals.ENVIRONMENT__NAME));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getEnvironmentAccess().getNameIDTerminalRuleCall_0(), semanticObject.getName());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     (error=XExpression source=XExpression? feature=XExpression?)
	 */
	 ...
	 */
	protected void sequence_ExpressionInConclusion(EObject context, ExpressionInConclusion semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, XsemanticsPackage.Literals.EXPRESSION_IN_CONCLUSION__EXPRESSION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XsemanticsPackage.Literals.EXPRESSION_IN_CONCLUSION__EXPRESSION));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
	 ...
	 */
	protected void sequence_JudgmentParameter(EObject context, InputParameter semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, XsemanticsPackage.Literals.INPUT_PARAMETER__PARAMETER) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XsemanticsPackage.Literals.INPUT_PARAMETER__PARAMETER));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getJudgmentParameterAccess().getParameterFullJvmFormalParameterParserRuleCall_1_1_0(), semanticObject.getParameter());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_JudgmentParameter(EObject context, OutputParameter semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, XsemanticsPackage.Literals.OUTPUT_PARAMETER__JVM_TYPE_REFERENCE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XsemanticsPackage.Literals.OUTPUT_PARAMETER__JVM_TYPE_REFERENCE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getJudgmentParameterAccess().getJvmTypeReferenceJvmTypeReferenceParserRuleCall_0_2_0(), semanticObject.getJvmTypeReference());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     (branches+=PremiseExpression_OrExpression_1_0_0 branches+=XExpressionInsideBlock)
	 */
	protected void sequence_PremiseExpression(EObject context, OrExpression semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     )
	 */
	protected void sequence_RuleInvocation(EObject context, RuleInvocation semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     parameter=FullJvmFormalParameter
	 */
	protected void sequence_RuleParameter(EObject context, RuleParameter semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, XsemanticsPackage.Literals.RULE_PARAMETER__PARAMETER) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XsemanticsPackage.Literals.RULE_PARAMETER__PARAMETER));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getRuleParameterAccess().getParameterFullJvmFormalParameterParserRuleCall_0(), semanticObject.getParameter());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     (key=XExpression value=XExpression)
	 */
	protected void sequence_TerminalEnvironmentSpecification(EObject context, EnvironmentMapping semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, XsemanticsPackage.Literals.ENVIRONMENT_MAPPING__KEY) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XsemanticsPackage.Literals.ENVIRONMENT_MAPPING__KEY));
			if(transientValues.isValueTransient(semanticObject, XsemanticsPackage.Literals.ENVIRONMENT_MAPPING__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XsemanticsPackage.Literals.ENVIRONMENT_MAPPING__VALUE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getTerminalEnvironmentSpecificationAccess().getKeyXExpressionParserRuleCall_1_1_0(), semanticObject.getKey());
		feeder.accept(grammarAccess.getTerminalEnvironmentSpecificationAccess().getValueXExpressionParserRuleCall_1_3_0(), semanticObject.getValue());
		feeder.finish();
	}
	 ...
	 *     (error=ErrorSpecification?)
	 */
	protected void sequence_TerminalPremiseExpression(EObject context, Fail semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     {XNullLiteral}
	 */
	protected void sequence_XExpressionInsideBlock(EObject context, XNullLiteral semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
