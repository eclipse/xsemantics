		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getXsemanticsSystemAccess().getJudgmentDescriptionsAssignment_6_2(), "rule__XsemanticsSystem__JudgmentDescriptionsAssignment_6_2");
					put(grammarAccess.getXsemanticsSystemAccess().getRulesAssignment_7(), "rule__XsemanticsSystem__RulesAssignment_7");
					put(grammarAccess.getXsemanticsSystemAccess().getCheckrulesAssignment_8(), "rule__XsemanticsSystem__CheckrulesAssignment_8");
