...
public class XsemanticsTestFiles {
  ...
  public CharSequence testErrorSpecifications() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("// this rule fails with its own error specification");
    _builder.newLine();
    _builder.append("rule SubtypeEStructuralFeature");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("G |- EStructuralFeature left <: EObject right");
    _builder.newLine();
    _builder.append("from { ");
    _builder.newLine();
    _builder.append("\t");
