...
public class TraceUtilsTests extends XsemanticsBaseTest {
  ...
  public void testWithNodeModelSources() {
      ...
      LinkedList<ErrorInformation> _removeNonNodeModelSources = this._traceUtils.removeNonNodeModelSources(_allErrorInformation);
      final LinkedList<ErrorInformation> list = _removeNonNodeModelSources;
  ...
  public void testFilteredErrorInformation() {
      ...
      LinkedList<ErrorInformation> _filteredErrorInformation = this._traceUtils.filteredErrorInformation(ex1);
      final LinkedList<ErrorInformation> list = _filteredErrorInformation;
      int _size_1 = list.size();
      Assert.assertEquals(2, _size_1);
  ...
  public void testInnermostRuleFailedExceptionWithNodeModelSources() {
      ...
      RuleFailedException _innermostRuleFailedExceptionWithNodeModelSources = this._traceUtils.innermostRuleFailedExceptionWithNodeModelSources(ex1);
      final RuleFailedException innerMost = _innermostRuleFailedExceptionWithNodeModelSources;
      Assert.assertSame(ex2, innerMost);
      LinkedList<ErrorInformation> _filteredErrorInformation = this._traceUtils.filteredErrorInformation(innerMost);
      final LinkedList<ErrorInformation> list = _filteredErrorInformation;
      int _size_1 = list.size();
  ...
  public void testFailureAsList() {
      ...
      RuleFailedException _ruleFailedException_1 = new RuleFailedException("first", ex2);
      final RuleFailedException ex1 = _ruleFailedException_1;
      LinkedList<RuleFailedException> _failureAsList = this._traceUtils.failureAsList(ex1);
      final LinkedList<RuleFailedException> list = _failureAsList;
  ...
  public void testFailureAsString() {
      ...
      RuleFailedException _ruleFailedException_2 = new RuleFailedException("first", ex2);
      final RuleFailedException ex1 = _ruleFailedException_2;
      String _failureTraceAsString = this._traceUtils.failureTraceAsString(ex1);
      final String trace = _failureTraceAsString;
  ...
  public void testRemoveDuplicateErrorInformation() {
      ...
      ex1.addErrorInformation(_errorInformation_3);
      LinkedList<ErrorInformation> _allErrorInformation = this._traceUtils.allErrorInformation(ex1);
      List<ErrorInformation> _removeDuplicateErrorInformation = this._traceUtils.removeDuplicateErrorInformation(_allErrorInformation);
      final List<ErrorInformation> list = _removeDuplicateErrorInformation;
      int _size = list.size();
