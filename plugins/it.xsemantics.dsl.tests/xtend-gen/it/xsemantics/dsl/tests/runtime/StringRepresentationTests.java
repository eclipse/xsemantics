...
public class StringRepresentationTests extends XsemanticsBaseTest {
  ...
  public void testList() {
    ArrayList<Object> _newArrayList = CollectionLiterals.<Object>newArrayList("foo", Integer.valueOf(10), Boolean.valueOf(true));
  ...
  public void testEnvironmentWithMappings() {
    ...
    final EDataType e = EcoreFactory.eINSTANCE.createEDataType();
