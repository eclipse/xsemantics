...
public class XsemanticsXbaseCompilerTest extends XsemanticsGeneratorBaseTest {
  ...
  public void testOrExpressionWithRuleInvocations() {
    ...
    StringConcatenation _builder = new StringConcatenation();
    _builder.newLine();
    _builder.append("/* {eClass.name == \'foo\' G |- object.eClass : eClass} or {G |- object.eClass : eClass object.eClass.name == \'bar\'} */");
    _builder.newLine();
    _builder.append("try {");
    _builder.newLine();
    _builder.append("  ");
    ...
    _builder.newLine();
    _builder.append("  ");
    _builder.append("String _name_1 = _eClass_2.getName();");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("boolean _equals_1 = Objects.equal(_name_1, \"bar\");");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("}");
    this.checkCompilationOfOr(_testOrExpressionWithRuleInvocations, 0, _builder);
  }
  ...
  public void testOrExpressionWithRuleInvocations2() {
    ...
    StringConcatenation _builder = new StringConcatenation();
    _builder.newLine();
    _builder.append("/* G |- object.eClass : eClass or G |- object.eClass : eClass */");
    _builder.newLine();
    _builder.append("try {");
    _builder.newLine();
    _builder.append("  ");
    ...
    _builder.newLine();
    _builder.append("}");
    this.checkCompilationOfOr(_testOrExpressionWithRuleInvocations2, 0, _builder);
  }
  ...
  public void testForClosures() {
    ...
    _builder.newLine();
    _builder.append("final Procedure1<EStructuralFeature> _function_2 = new Procedure1<EStructuralFeature>() {");
    _builder.newLine();
    _builder.append("  ");
    ...
    _builder.append("};");
    _builder.newLine();
    _builder.append("IterableExtensions.<EStructuralFeature>forEach(_eStructuralFeatures_2, _function_2);");
    _builder.newLine();
