...
public class XsemanticsJvmModelGeneratorTest extends XsemanticsBaseTest {
  ...
  public void testCheckRule() {
    ...
    _builder.newLine();
    _builder.append("  ");
    _builder.append("private EClass EObjectEClass_exp_1(final RuleEnvironment G, final RuleApplicationTrace _trace_, final EObject object) throws RuleFailedException {");
    _builder.newLine();
    _builder.append("    ");
  ...
  public void testExpressionsInConclusion() {
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("return new Result2<EObject,EStructuralFeature>(TwoExpressionsInConclusion_exp_1(G, _trace_, cl), TwoExpressionsInConclusion_exp_2(G, _trace_, cl));");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("  ");
    _builder.append("private EClass TwoExpressionsInConclusion_exp_1(final RuleEnvironment G, final RuleApplicationTrace _trace_, final EClass cl) throws RuleFailedException {");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("  ");
    _builder.append("private EStructuralFeature TwoExpressionsInConclusion_exp_2(final RuleEnvironment G, final RuleApplicationTrace _trace_, final EClass cl) throws RuleFailedException {");
    _builder.newLine();
    _builder.append("    ");
  ...
  public void testAccessToThisInExpressionsInConclusion() {
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("return new Result<EClass>(EObjectEClass_exp_1(G, _trace_, o));");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("  ");
    _builder.append("private EClass EObjectEClass_exp_1(final RuleEnvironment G, final RuleApplicationTrace _trace_, final EObject o) throws RuleFailedException {");
    _builder.newLine();
    _builder.append("    ");
