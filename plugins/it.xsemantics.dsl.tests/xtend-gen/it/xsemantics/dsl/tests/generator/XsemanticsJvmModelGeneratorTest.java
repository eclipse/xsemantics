...
public class XsemanticsJvmModelGeneratorTest extends XsemanticsBaseTest {
  ...
  public void testErrorSpecifications() {
    ...
    _builder.newLine();
    _builder.append("      ");
    _builder.append("throwRuleFailedException(ruleName(\"SubtypeEClass\") + stringRepForEnv(G) + \" |- \" + stringRep(left) + \" <: \" + stringRep(right),");
    _builder.newLine();
    _builder.append("      \t");
    _builder.append("SUBTYPEECLASS,");
    _builder.newLine();
    _builder.append("      \t");
    _builder.append("e_applyRuleSubtypeEClass, new ErrorInformation(left), new ErrorInformation(right));");
    _builder.newLine();
    _builder.append("      ");
    _builder.append("return null;");
    _builder.newLine();
