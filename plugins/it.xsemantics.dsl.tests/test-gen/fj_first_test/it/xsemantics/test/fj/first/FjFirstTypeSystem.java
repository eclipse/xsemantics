...
public class FjFirstTypeSystem extends XsemanticsRuntimeSystem {
	...
	protected PolymorphicDispatcher<Result<List<it.xsemantics.example.fj.fj.Class>>> superclassesDispatcher;
	
	protected PolymorphicDispatcher<Result<List<Field>>> fieldsDispatcher;
	
	protected PolymorphicDispatcher<Result<List<Method>>> methodsDispatcher;
	...
	public Result<List<it.xsemantics.example.fj.fj.Class>> superclasses(final RuleEnvironment _environment_, final RuleApplicationTrace _trace_,
	...
	public Result<List<Field>> fields(final it.xsemantics.example.fj.fj.Class cl) {
		return fields(new RuleEnvironment(),
			null, cl);
	}
	...
	public Result<List<Method>> methods(final it.xsemantics.example.fj.fj.Class cl) {
		return methods(new RuleEnvironment(),
			null, cl);
	}
	...
	protected Result<List<it.xsemantics.example.fj.fj.Class>> superclassesInternal(final RuleEnvironment _environment_, final RuleApplicationTrace _trace_,
			final it.xsemantics.example.fj.fj.Class cl) {
		try {
	...
	protected Result<List<Field>> fieldsInternal(final RuleEnvironment _environment_, final RuleApplicationTrace _trace_,
			final it.xsemantics.example.fj.fj.Class cl) {
		try {
			checkParamsNotNull(cl);
	...
	protected Result<List<Method>> methodsInternal(final RuleEnvironment _environment_, final RuleApplicationTrace _trace_,
			final it.xsemantics.example.fj.fj.Class cl) {
		try {
			checkParamsNotNull(cl);
	...
	protected Result<Boolean> subtypesequenceImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_,
			final Expression owner, final List<Expression> expressions, final List<TypedElement> typedElements) 
			throws RuleFailedException {
		try {
			RuleApplicationTrace _subtrace_ = newTrace(_trace_);
	...
	protected Result<List<it.xsemantics.example.fj.fj.Class>> superclassesImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_,
			final it.xsemantics.example.fj.fj.Class cl) 
			throws RuleFailedException {
		try {
			RuleApplicationTrace _subtrace_ = newTrace(_trace_);
	...
	protected Result<List<it.xsemantics.example.fj.fj.Class>> applyRuleSuperclasses(final RuleEnvironment G, final RuleApplicationTrace _trace_,
			final it.xsemantics.example.fj.fj.Class cl) 
			throws RuleFailedException {
	...
	protected Result<List<Field>> fieldsImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_,
			final it.xsemantics.example.fj.fj.Class cl) 
			throws RuleFailedException {
		try {
			RuleApplicationTrace _subtrace_ = newTrace(_trace_);
	...
	protected Result<List<Field>> applyRuleFields(final RuleEnvironment G, final RuleApplicationTrace _trace_,
			final it.xsemantics.example.fj.fj.Class cl) 
			throws RuleFailedException {
		...
		
		{
		  ...
		  EReference _class_Superclass = FjPackage.eINSTANCE.getClass_Superclass();
		  List<Field> _all = this.<Field>getAll(cl, _class_Members, _class_Superclass, it.xsemantics.example.fj.fj.Field.class);
		  fields = _all;
	...
	protected Result<List<Method>> methodsImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_,
			final it.xsemantics.example.fj.fj.Class cl) 
			throws RuleFailedException {
		try {
			RuleApplicationTrace _subtrace_ = newTrace(_trace_);
	...
	protected Result<List<Method>> applyRuleMethods(final RuleEnvironment G, final RuleApplicationTrace _trace_,
			final it.xsemantics.example.fj.fj.Class cl) 
			throws RuleFailedException {
		...
		
		{
		  ...
		  EReference _class_Members = FjPackage.eINSTANCE.getClass_Members();
		  EReference _class_Superclass = FjPackage.eINSTANCE.getClass_Superclass();
		  List<Method> _all = this.<Method>getAll(cl, _class_Members, _class_Superclass, it.xsemantics.example.fj.fj.Method.class);
		  final List<Method> allMethods = _all;
		...
		if (_operator_notEquals) {
		  {
		    ...
		    final Procedure1<Field> _function = new Procedure1<Field>() {
		        public void apply(final Field inheritedField) {
		          ...
		          List<Field> _typeSelect = EcoreUtil2.<Field>typeSelect(_members, it.xsemantics.example.fj.fj.Field.class);
		    ...
		    final Procedure1<Method> _function_1 = new Procedure1<Method>() {
		        public void apply(final Method inheritedMethod) {
		          EList<Member> _members = cl.getMembers();
		          List<Method> _typeSelect = EcoreUtil2.<Method>typeSelect(_members, it.xsemantics.example.fj.fj.Method.class);
		          final Procedure1<Method> _function = new Procedure1<Method>() {
