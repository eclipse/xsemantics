...
public class FjActualTypeSystemWrapper implements IFjTypeSystem {

	@Inject FjTypeSystem ts;
	...
	public Result<Boolean> subtypesequence(RuleEnvironment _environment_,
			...
			List<Expression> _List, List<? extends TypedElement> _List_1) {
		return ts.subtypesequence(_environment_, _trace_, owner, _List, _List_1);
	}
