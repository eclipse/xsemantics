...
class XsemanticsUtilsTest extends XsemanticsBaseTest {
	...
	def void testOriginalSystemDefinition() {
		systemExtendsSystemWithJudgments.
				...
				name.assertEqualsStrings('org.eclipse.xsemantics.test.TypeSystem')
	}
	...
	def void testAllSuperSystemDefinitions() {
		systemExtendsSystemWithJudgments.
				...
				head.name.
				assertEqualsStrings('org.eclipse.xsemantics.test.TypeSystem')
	}
	...
	def void testAllSuperSystemDefinitions2() {
		...
		superSystems.get(0).name.
				assertEqualsStrings('org.eclipse.xsemantics.test.ExtendedTypeSystem')
...
'''
org.eclipse.xsemantics.test.ExtendedTypeSystem subtype |- EClass c1 <: EClass c2
org.eclipse.xsemantics.test.TypeSystem type |- EObject c : output EClass error "this " + c + " made an error!" source c feature c.eClass.eContainingFeature
'''					
				)
	}
	...
	def void testAllJudgments2() {
		systemExtendsExtendedTypeSystem.
				allJudgments.assertJudgments(
'''
org.eclipse.xsemantics.test.ExtendedTypeSystem2 type2 ||- EClass c1 : EClass c2
org.eclipse.xsemantics.test.ExtendedTypeSystem subtype |- EClass c1 <: EClass c2
org.eclipse.xsemantics.test.TypeSystem type |- EObject c : output EClass error "this " + c + " made an error!" source c feature c.eClass.eContainingFeature
'''					
				)
	...
	def void testAllJudgmentsWithOverride() {
		systemExtendsSystemWithJudgmentOverride
			.parseSystemsAndAssertNoErrors.
				allJudgments.assertJudgments(
'''
org.eclipse.xsemantics.test.ExtendedTypeSystemWithJudgmentOverride override type |- EObject obj : output EClass
org.eclipse.xsemantics.test.ExtendedTypeSystemWithJudgmentOverride override subtype |- EClass c1 <: EClass c2 error stringRep(c1) + " not <: " + stringRep(c2) source c1 feature c1.eClass.eContainingFeature
org.eclipse.xsemantics.test.ExtendedTypeSystem2 type2 ||- EClass c1 : EClass c2
org.eclipse.xsemantics.test.ExtendedTypeSystem subtype |- EClass c1 <: EClass c2
org.eclipse.xsemantics.test.TypeSystem type |- EObject c : output EClass error "this " + c + " made an error!" source c feature c.eClass.eContainingFeature
'''					
