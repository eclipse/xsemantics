 ...
 * <ul>
 *   <li>{@link it.xsemantics.example.lambda.lambda.impl.StringConstantImpl#getString <em>String</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringConstantImpl extends ConstantImpl implements StringConstant
{
  ...
  {
    return LambdaPackage.Literals.STRING_CONSTANT;
  }
  ...
  public void setString(String newString)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LambdaPackage.STRING_CONSTANT__STRING, oldString, string));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LambdaPackage.STRING_CONSTANT__STRING:
        return getString();
    }
