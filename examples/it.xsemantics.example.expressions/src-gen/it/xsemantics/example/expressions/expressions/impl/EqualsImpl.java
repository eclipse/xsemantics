 ...
 * <ul>
 *   <li>{@link it.xsemantics.example.expressions.expressions.impl.EqualsImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link it.xsemantics.example.expressions.expressions.impl.EqualsImpl#getOp <em>Op</em>}</li>
 *   <li>{@link it.xsemantics.example.expressions.expressions.impl.EqualsImpl#getRight <em>Right</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EqualsImpl extends ExpressionImpl implements Equals
{
  ...
  public void setOp(String newOp)
  {
    ...
    op = newOp;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.EQUALS__OP, oldOp, op));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ExpressionsPackage.EQUALS__LEFT:
        return getLeft();
      case ExpressionsPackage.EQUALS__OP:
        return getOp();
      case ExpressionsPackage.EQUALS__RIGHT:
        return getRight();
    }
