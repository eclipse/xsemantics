 ...
 * <ul>
 *   <li>{@link it.xsemantics.example.expressions.expressions.impl.ComparisonImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link it.xsemantics.example.expressions.expressions.impl.ComparisonImpl#getOp <em>Op</em>}</li>
 *   <li>{@link it.xsemantics.example.expressions.expressions.impl.ComparisonImpl#getRight <em>Right</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
