 ...
 * <ul>
 *   <li>{@link it.xsemantics.example.expressions.expressions.impl.ModelImpl#getVariables <em>Variables</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  public EList<Variable> getVariables()
  {
    if (variables == null)
    {
      variables = new EObjectContainmentEList<Variable>(Variable.class, this, ExpressionsPackage.MODEL__VARIABLES);
    }
    return variables;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ExpressionsPackage.MODEL__VARIABLES:
