...
public class FirstExpressionsSemantics extends XsemanticsRuntimeSystem {
  ...
  public FirstExpressionsSemantics() {
    init();
  }
  ...
  protected Result<Object> interpretImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_, final StringLiteral string) throws RuleFailedException {
    try {
      ...
      throwRuleFailedException(ruleName("InterpretStringLiteral") + stringRepForEnv(G) + " |- " + stringRep(string) + " ~> " + "String",
