...
public class TVariableTypeRule extends LambdaTypeSystemRule {
	...
	protected Variable<org.eclipse.xsemantics.example.lambda.lambda.Variable> var_v = new Variable<org.eclipse.xsemantics.example.lambda.lambda.Variable>(
	...
	@Override
	public Variable<org.eclipse.xsemantics.example.lambda.lambda.Variable> getLeft() {
		return var_v;
	}
