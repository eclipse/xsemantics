...
public class TParamTypeRule extends LambdaTypeSystemRule {
	...
	protected Variable<org.eclipse.xsemantics.example.lambda.lambda.Parameter> var_p = new Variable<org.eclipse.xsemantics.example.lambda.lambda.Parameter>(
	...
	@Override
	public Variable<org.eclipse.xsemantics.example.lambda.lambda.Parameter> getLeft() {
		return var_p;
	}
