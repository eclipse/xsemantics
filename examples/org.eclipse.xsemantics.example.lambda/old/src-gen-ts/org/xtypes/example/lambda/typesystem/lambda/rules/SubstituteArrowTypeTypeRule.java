...
public class SubstituteArrowTypeTypeRule extends LambdaTypeSystemRule {
	...
	protected Variable<org.eclipse.xsemantics.example.lambda.lambda.Type> var_newLeft = new Variable<org.eclipse.xsemantics.example.lambda.lambda.Type>(
			createEClassifierType(basicPackage.getType()));

	protected Variable<org.eclipse.xsemantics.example.lambda.lambda.Type> var_newRight = new Variable<org.eclipse.xsemantics.example.lambda.lambda.Type>(
			createEClassifierType(basicPackage.getType()));

	protected Variable<org.eclipse.xsemantics.example.lambda.lambda.ArrowType> var_a = new Variable<org.eclipse.xsemantics.example.lambda.lambda.ArrowType>(
	...
	public void applyImpl() throws RuleFailedException {
		...
		var_newLeft = new Variable<org.eclipse.xsemantics.example.lambda.lambda.Type>(
				createEClassifierType(basicPackage.getType()), null);

		var_newRight = new Variable<org.eclipse.xsemantics.example.lambda.lambda.Type>(
				createEClassifierType(basicPackage.getType()), null);
