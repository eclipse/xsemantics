		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAtomicAccess().getValueAlternatives_5_1_0(), "rule__Atomic__ValueAlternatives_5_1_0");
					...
					put(grammarAccess.getAtomicAccess().getExpressionAssignment_2_2(), "rule__Atomic__ExpressionAssignment_2_2");
