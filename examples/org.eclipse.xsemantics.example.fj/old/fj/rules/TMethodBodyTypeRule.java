...
public class TMethodBodyTypeRule extends FJTypeSystemRule {
	...
	protected Variable<org.eclipse.xsemantics.example.fj.fj.MethodBody> var_m = new Variable<org.eclipse.xsemantics.example.fj.fj.MethodBody>(
	...
	@Override
	public Variable<org.eclipse.xsemantics.example.fj.fj.MethodBody> getLeft() {
		return var_m;
	}
