...
public class TFieldSelectionTypeRule extends FJTypeSystemRule {
	...
	protected Variable<org.eclipse.xsemantics.example.fj.fj.FieldSelection> var_f = new Variable<org.eclipse.xsemantics.example.fj.fj.FieldSelection>(
	...
	@Override
	public Variable<org.eclipse.xsemantics.example.fj.fj.FieldSelection> getLeft() {
		return var_f;
	}
