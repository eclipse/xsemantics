...
public class StringConstantTypeRule extends FJTypeSystemRule {
	...
	protected Variable<org.eclipse.xsemantics.example.fj.fj.StringConstant> var_s = new Variable<org.eclipse.xsemantics.example.fj.fj.StringConstant>(
	...
	@Override
	public Variable<org.eclipse.xsemantics.example.fj.fj.StringConstant> getLeft() {
		return var_s;
	}
