...
public class TSelectionTypeRule extends FJTypeSystemRule {
	...
	protected Variable<org.eclipse.xsemantics.example.fj.fj.Type> var_receiverType = new Variable<org.eclipse.xsemantics.example.fj.fj.Type>(
			createEClassifierType(basicPackage.getType()));

	protected Variable<org.eclipse.xsemantics.example.fj.fj.Selection> var_e = new Variable<org.eclipse.xsemantics.example.fj.fj.Selection>(
	...
	@Override
	public Variable<org.eclipse.xsemantics.example.fj.fj.Selection> getLeft() {
		return var_e;
	}
	...
	public void applyImpl() throws RuleFailedException {
		...
		var_receiverType = new Variable<org.eclipse.xsemantics.example.fj.fj.Type>(
