...
public class SubClassTypeRule extends FJTypeSystemRule {
	...
	protected Variable<org.eclipse.xsemantics.example.fj.fj.Class> var_C1 = new Variable<org.eclipse.xsemantics.example.fj.fj.Class>(
			createEClassifierType(basicPackage.getClass_()));

	protected Variable<org.eclipse.xsemantics.example.fj.fj.Class> var_C2 = new Variable<org.eclipse.xsemantics.example.fj.fj.Class>(
			createEClassifierType(basicPackage.getClass_()));
	...
	@Override
	public Variable<org.eclipse.xsemantics.example.fj.fj.Class> getRight() {
		return var_C2;
	}
