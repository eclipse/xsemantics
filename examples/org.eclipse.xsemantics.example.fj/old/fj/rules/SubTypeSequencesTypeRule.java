...
public class SubTypeSequencesTypeRule extends FJTypeSystemRule {
	...
	protected Variable<java.util.List<org.eclipse.xsemantics.example.fj.fj.Expression>> var_args = new Variable<java.util.List<org.eclipse.xsemantics.example.fj.fj.Expression>>(
			createCollectionType(createEClassifierType(basicPackage
					.getExpression())));

	protected Variable<java.util.List<org.eclipse.xsemantics.example.fj.fj.Parameter>> var_params = new Variable<java.util.List<org.eclipse.xsemantics.example.fj.fj.Parameter>>(
			createCollectionType(createEClassifierType(basicPackage
					.getParameter())));
	...
	@Override
	public Variable<java.util.List<org.eclipse.xsemantics.example.fj.fj.Expression>> getLeft() {
		return var_args;
	}
