...
public class TFieldOkTypeRule extends FJTypeSystemRule {
	...
	protected Variable<org.eclipse.xsemantics.example.fj.fj.Field> var_inheritedField = new Variable<org.eclipse.xsemantics.example.fj.fj.Field>(
			createEClassifierType(basicPackage.getField()));

	protected Variable<org.eclipse.xsemantics.example.fj.fj.Field> var_otherField = new Variable<org.eclipse.xsemantics.example.fj.fj.Field>(
			createEClassifierType(basicPackage.getField()));
	...
	public void applyImpl() throws RuleFailedException {
		...
		var_C = new Variable<org.eclipse.xsemantics.example.fj.fj.Class>(
		...
		try {
			...
			try {
				for (java.util.Iterator<org.eclipse.xsemantics.example.fj.fj.Field> iterator = getAll(
						var_C.getValue().getSuperclass(), "members", "superclass",
						org.eclipse.xsemantics.example.fj.fj.Field.class).iterator(); iterator
						.hasNext();) {
		...
		try {
			...
			try {
				for (java.util.Iterator<org.eclipse.xsemantics.example.fj.fj.Field> iterator = FjAuxiliaryFunctions.selectFields(var_C
