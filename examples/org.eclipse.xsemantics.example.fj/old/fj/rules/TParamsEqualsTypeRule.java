...
public class TParamsEqualsTypeRule extends FJTypeSystemRule {
	...
	protected Variable<java.util.List<org.eclipse.xsemantics.example.fj.fj.Parameter>> var_params1 = new Variable<java.util.List<org.eclipse.xsemantics.example.fj.fj.Parameter>>(
			createCollectionType(createEClassifierType(basicPackage
					.getParameter())));

	protected Variable<java.util.List<org.eclipse.xsemantics.example.fj.fj.Parameter>> var_params2 = new Variable<java.util.List<org.eclipse.xsemantics.example.fj.fj.Parameter>>(
			createCollectionType(createEClassifierType(basicPackage
					.getParameter())));
	...
	@Override
	public Variable<java.util.List<org.eclipse.xsemantics.example.fj.fj.Parameter>> getLeft() {
		return var_params1;
	}

	@Override
	public Variable<java.util.List<org.eclipse.xsemantics.example.fj.fj.Parameter>> getRight() {
		return var_params2;
	}
