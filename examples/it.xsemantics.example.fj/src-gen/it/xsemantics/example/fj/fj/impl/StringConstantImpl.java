 ...
 * <ul>
 *   <li>{@link it.xsemantics.example.fj.fj.impl.StringConstantImpl#getConstant <em>Constant</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringConstantImpl extends ConstantImpl implements StringConstant
{
  ...
  {
    return FjPackage.Literals.STRING_CONSTANT;
  }
  ...
  public void setConstant(String newConstant)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FjPackage.STRING_CONSTANT__CONSTANT, oldConstant, constant));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FjPackage.STRING_CONSTANT__CONSTANT:
        return getConstant();
    }
