 ...
 * <ul>
 *   <li>{@link it.xsemantics.example.fj.fj.BasicType#getBasic <em>Basic</em>}</li>
 * </ul>
 * </p>
 *
 * @see it.xsemantics.example.fj.fj.FjPackage#getBasicType()
 * @model
 * @generated
 */
public interface BasicType extends Type
{
   ...
   * @see #setBasic(String)
   * @see it.xsemantics.example.fj.fj.FjPackage#getBasicType_Basic()
   * @model
   * @generated
   */
  String getBasic();
  ...
  /**
   * Sets the value of the '{@link it.xsemantics.example.fj.fj.BasicType#getBasic <em>Basic</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
