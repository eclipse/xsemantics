 ...
 * <ul>
 *   <li>{@link it.xsemantics.example.fj.fj.impl.IntConstantImpl#getConstant <em>Constant</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntConstantImpl extends ConstantImpl implements IntConstant
{
  ...
  {
    return FjPackage.Literals.INT_CONSTANT;
  }
  ...
  public void setConstant(int newConstant)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FjPackage.INT_CONSTANT__CONSTANT, oldConstant, constant));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FjPackage.INT_CONSTANT__CONSTANT:
        return getConstant();
    }
