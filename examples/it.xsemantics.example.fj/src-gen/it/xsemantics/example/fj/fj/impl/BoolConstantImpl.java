 ...
 * <ul>
 *   <li>{@link it.xsemantics.example.fj.fj.impl.BoolConstantImpl#getConstant <em>Constant</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BoolConstantImpl extends ConstantImpl implements BoolConstant
{
  ...
  {
    return FjPackage.Literals.BOOL_CONSTANT;
  }
  ...
  public void setConstant(String newConstant)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FjPackage.BOOL_CONSTANT__CONSTANT, oldConstant, constant));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FjPackage.BOOL_CONSTANT__CONSTANT:
        return getConstant();
    }
