...
public class TThisTypeRule extends FJTypeSystemRule {
	...
	protected Variable<it.xsemantics.example.fj.fj.This> var_t = new Variable<it.xsemantics.example.fj.fj.This>(
	...
	@Override
	public Variable<it.xsemantics.example.fj.fj.This> getLeft() {
		return var_t;
	}
	...
	public void applyImpl() throws RuleFailedException {
		...
		getRight().setValue(
				castto(env(env_G, "this"), it.xsemantics.example.fj.fj.Type.class));
