...
public class FjTypeSystem extends XsemanticsRuntimeSystem {
	...
	protected PolymorphicDispatcher<Result<Boolean>> assignableDispatcher;
	
	protected PolymorphicDispatcher<Result<Boolean>> equalstypeDispatcher;
	
	protected PolymorphicDispatcher<Result<Boolean>> overridesDispatcher;
	...
	public Result<Boolean> assignable(final RuleEnvironment _environment_, final RuleApplicationTrace _trace_,
			final Expression expression, final Type right) {
		try {
		  ...
		  if (_operator_notEquals) {
		    {
		      ...
		      EReference _class_Members = FjPackage.eINSTANCE.getClass_Members();
		      EReference _class_Superclass = FjPackage.eINSTANCE.getClass_Superclass();
		      List<Method> _all = this.<Method>getAll(_superclass_1, _class_Members, _class_Superclass, it.xsemantics.example.fj.fj.Method.class);
		      List<Method> inheritedMethods = _all;
	...
	protected void assignableThrowException(String _issue, Exception _ex, final Expression expression, final Type right) 
			throws RuleFailedException {
	...
	protected Result<Boolean> assignableInternal(final RuleEnvironment _environment_, final RuleApplicationTrace _trace_,
			final Expression expression, final Type right) {
		try {
	...
	protected void equalstypeThrowException(String _issue, Exception _ex, final Type left, final Type right) 
			throws RuleFailedException {
	...
	protected void overridesThrowException(String _issue, Exception _ex, final Method current, final Method previous) 
			throws RuleFailedException {
	...
	protected Result<Boolean> overridesInternal(final RuleEnvironment _environment_, final RuleApplicationTrace _trace_,
			final Method current, final Method previous) {
		try {
	...
	protected void subtypesequenceThrowException(String _issue, Exception _ex, final Expression owner, final List<Expression> expressions, final List<? extends TypedElement> elements) 
			throws RuleFailedException {
	...
	protected Result<Type> applyRuleTSelection(final RuleEnvironment G, final RuleApplicationTrace _trace_,
		...
		Member _message_1 = selection.getMessage();
		Type _type = _message_1.getType();
		return new Result<Type>(_type);
	}
	...
	protected Result<Boolean> applyRuleGeneralSubtyping(final RuleEnvironment G, final RuleApplicationTrace _trace_,
			final Type left, final Type right) 
			throws RuleFailedException {
	...
	protected Result<Boolean> assignableImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_,
			final Expression expression, final Type right) 
			throws RuleFailedException {
		try {
			RuleApplicationTrace _subtrace_ = newTrace(_trace_);
	...
	protected Result<Boolean> applyRuleExpressionAssignableToType(final RuleEnvironment G, final RuleApplicationTrace _trace_,
			final Expression expression, final Type right) 
			throws RuleFailedException {
	...
	protected Result<Boolean> applyRuleGeneralEquals(final RuleEnvironment G, final RuleApplicationTrace _trace_,
			final Type left, final Type right) 
			throws RuleFailedException {
	...
	protected Result<Boolean> overridesImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_,
			final Method current, final Method previous) 
			throws RuleFailedException {
		try {
			RuleApplicationTrace _subtrace_ = newTrace(_trace_);
	...
	protected Result<Boolean> applyRuleMethodOverride(final RuleEnvironment G, final RuleApplicationTrace _trace_,
			final Method current, final Method previous) 
			throws RuleFailedException {
