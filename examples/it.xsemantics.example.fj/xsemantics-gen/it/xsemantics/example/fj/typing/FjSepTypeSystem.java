...
public class FjSepTypeSystem extends XsemanticsRuntimeSystem {
	...
	protected Result<Boolean> overridesImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_,
		...
		try {
			...
			overridesThrowException(CHECKMETHODOVERRIDEPREDICATE,
				e_applyRuleCheckMethodOverridePredicate, current, previous);
			return null;
		}
	}
	
	protected Result<Boolean> applyRuleCheckMethodOverridePredicate(final RuleEnvironment G, final RuleApplicationTrace _trace_,
			final Method current, final Method previous) 
			throws RuleFailedException {
